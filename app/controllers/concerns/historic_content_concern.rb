module HistoricContentConcern
  ...
  def forbid_editing_of_historic_content!
    ...
    if @edition.historic? && !can?(:modify, @edition)
      message = "This document is in <a href='https://www.gov.uk/guidance/how-to-publish-on-gov-uk/creating-and-updating-pages#history-mode' class='govuk-link'>history mode</a>. Please contact your GOV.UK lead or managing editor if you need to change it."
